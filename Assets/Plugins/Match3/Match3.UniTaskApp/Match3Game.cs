...
using Match3.UniTaskApp.Internal;

namespace Match3.UniTaskApp
{
    public abstract class Match3Game<TGridSlot> : BaseGame<TGridSlot> where TGridSlot : IGridSlot
    {
        ...
        protected Match3Game(IItemSwapper<TGridSlot> itemSwapper, GameConfig<TGridSlot> config) : base(config)
        {
